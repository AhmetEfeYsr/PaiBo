...
const KICK_REDIRECT_URI = process.env.KICK_REDIRECT_URI || "https://kz1d3kezb3.execute-api.eu-north-1.amazonaws.com/default/kick_oauth_callback"; // Bu Lambda'nın kendi API Gateway URL'si
